...
import os
import codecs
output_dir = r"C:\Users\PPD\Desktop\data\change\ner/process_data/"
...
def main():
    #读入数据文本
    train_df = pd.read_csv(r"C:\Users\PPD\Desktop\data\change\ner/Train_Data.csv", encoding="utf-8-sig")
    test_df = pd.read_csv(r"C:\Users\PPD\Desktop\data\change\ner/Test_Data.csv", encoding="utf-8-sig")
...
if __name__ == "__main__":
    main()
    test_pred = codecs.open(r'C:\Users\PPD\Desktop\data\change\ner/label_test.txt').readlines()
